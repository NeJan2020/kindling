...
import (
	...
	fmt "fmt"
	github_com_Kindling_project_kindling_collector_consumer_exporter_flattenexporter_data "github.com/Kindling-project/kindling/collector/consumer/exporter/flattenexporter/data"
...
type Span struct {
	...
	TraceId github_com_Kindling_project_kindling_collector_consumer_exporter_flattenexporter_data.TraceID `protobuf:"bytes,1,opt,name=trace_id,json=traceId,proto3,customtype=github.com/Kindling-project/kindling/collector/consumer/exporter/flattenexporter/data.TraceID" json:"trace_id"`
	...
	//
	// This field is required.
	SpanId github_com_Kindling_project_kindling_collector_consumer_exporter_flattenexporter_data.SpanID `protobuf:"bytes,2,opt,name=span_id,json=spanId,proto3,customtype=github.com/Kindling-project/kindling/collector/consumer/exporter/flattenexporter/data.SpanID" json:"span_id"`
	...
	ParentSpanId github_com_Kindling_project_kindling_collector_consumer_exporter_flattenexporter_data.SpanID `protobuf:"bytes,4,opt,name=parent_span_id,json=parentSpanId,proto3,customtype=github.com/Kindling-project/kindling/collector/consumer/exporter/flattenexporter/data.SpanID" json:"parent_span_id"`
