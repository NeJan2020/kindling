...
import (
	"context"
	component2 "github.com/Kindling-project/kindling/collector/pkg/component/consumer/exporter/flattenexporter/internal/component"
)

// StartFunc specifies the function invoked when the component.Component is being started.
type StartFunc func(context.Context, component2.Host) error

// Start calls f(ctx, host).
func (f StartFunc) Start(ctx context.Context, host component2.Host) error {
	return f(ctx, host)
}
...
func New(options ...Option) component2.Component {
	bc := &baseComponent{
		StartFunc:    func(ctx context.Context, host component2.Host) error { return nil },
