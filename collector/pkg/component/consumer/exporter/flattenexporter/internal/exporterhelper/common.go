...
import (
	...
	"github.com/Kindling-project/kindling/collector/pkg/component/consumer/exporter/flattenexporter/internal/component/componenthelper"
...
func (be *baseExporter) Start(ctx context.Context, host component2.Host) error {
