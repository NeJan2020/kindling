...
import (
	...
	fmt "fmt"
	github_com_Kindling_project_kindling_collector_pkg_consumer_exporter_flattenexporter_data "github.com/Kindling-project/kindling/collector/pkg/component/consumer/exporter/flattenexporter/data"
...
type Span struct {
	...
	TraceId github_com_Kindling_project_kindling_collector_pkg_consumer_exporter_flattenexporter_data.TraceID `protobuf:"bytes,1,opt,name=trace_id,json=traceId,proto3,customtype=github.com/Kindling-project/kindling/collector/pkg/component/consumer/exporter/flattenexporter/data.TraceID" json:"trace_id"`
	...
	//
	// This field is required.
	SpanId github_com_Kindling_project_kindling_collector_pkg_consumer_exporter_flattenexporter_data.SpanID `protobuf:"bytes,2,opt,name=span_id,json=spanId,proto3,customtype=github.com/Kindling-project/kindling/collector/pkg/component/consumer/exporter/flattenexporter/data.SpanID" json:"span_id"`
	...
	ParentSpanId github_com_Kindling_project_kindling_collector_pkg_consumer_exporter_flattenexporter_data.SpanID `protobuf:"bytes,4,opt,name=parent_span_id,json=parentSpanId,proto3,customtype=github.com/Kindling-project/kindling/collector/pkg/component/consumer/exporter/flattenexporter/data.SpanID" json:"parent_span_id"`
	...
	Service *v11.Service `protobuf:"bytes,16,opt,name=service,proto3" json:"service,omitempty"`
}
...
func (m *Span) GetService() *v11.Service {
	if m != nil {
		return m.Service
	}
	return nil
...
var fileDescriptor_5c407ac9c675a601 = []byte{
	...
	,
}
